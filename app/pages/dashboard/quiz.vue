            ...
            <UCard v-if="quiz.length === 0">
                    <template #header>
                        <div class="flex items-center justify-between">
                            ...
                            <UButton color="gray" variant="ghost" icon="i-heroicons-arrow-left" @click="router.push('/dashboard/notes')">Wróć do notatek</UButton>
                        </div>
                    </template>
                    ...
                    <div class="flex flex-col items-center justify-center my-10 space-y-6">
                        ...
                        <template v-if="!errorMsg || fileText">
                            <div class="text-center space-y-2">
                                ...
                                <p class="text-gray-500 max-w-md mx-auto">Sztuczna inteligencja przeanalizuje treść Twojej notatki i zapyta Cię o najważniejsze zagadnienia.</p>
                            </div>
                ...
                <div v-if="quiz.length > 0" class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <UButton color="gray" variant="ghost" icon="i-heroicons-arrow-path" @click="quiz = []">Nowy Quiz</UButton>
                    </div>
                    ...
                    <UCard v-for="(q, index) in quiz" :key="index" class="relative shadow-sm hover:shadow transition-shadow">
                        <div class="font-semibold text-xl mb-6 flex items-start gap-3">
                            <UBadge size="lg" color="primary" variant="subtle" class="shrink-0 mt-0.5">{{ index + 1 }}</UBadge>
