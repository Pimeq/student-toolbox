    ...
    <UDashboardPanel>
        ...
        <div class="flex-1 min-h-0 overflow-y-auto p-6 space-y-8">
            ...
            <UAlert 
                ...
                description="Nie udało się załadować notatek. Spróbuj odświeżyć stronę."
            />

            <div v-else-if="notes.length === 0" class="text-center py-16 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-2xl">
            ...
            <div v-else class="grid grid-cols-1 gap-4">
                ...
                >
                    <div class="flex items-center gap-4">
                        <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg group-hover:bg-primary-50 dark:group-hover:bg-primary-900/20 transition-colors">
                            <UIcon name="i-heroicons-document-text" class="w-6 h-6 text-gray-400 group-hover:text-primary" />
                        </div>
                        <div>
                            <h3 class="font-bold text-lg text-gray-900 dark:text-white">{{ note.title || 'Bez tytułu' }}</h3>
